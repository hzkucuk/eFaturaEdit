...
namespace QLicense
{
    ...
    public abstract class LicenseEntity
    {
        ...
        [Browsable(false)]
        [XmlElement("UID")]
        [ShowInLicenseInfo(true,"UID",ShowInLicenseInfoAttribute.FormatType.String)]
        public string UID { get; set; }

        [Browsable(false)]
        [XmlElement("Type")]
        [ShowInLicenseInfo(true, "Lisans Tipi", ShowInLicenseInfoAttribute.FormatType.EnumDescription)]
        public LicenseTypes Type { get; set; }

        [Browsable(false)]
        [XmlElement("CreateDateTime")]
        [ShowInLicenseInfo(true, "Lisans Verilme Tarihi", ShowInLicenseInfoAttribute.FormatType.DateTime)]
